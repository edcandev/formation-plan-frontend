...
const HeaderComponent = () => {
  ...
  <h2 className="header-component-container-h2">Tecnológico de Estudios Superiores de Ecatepec</h2>
        <h1 className='main-container-h1 my-3 text-center header-component-container-h1'>  Generador de Planes de Formación<br/>Especialidad Dual<br/>Innovación Tecnológica</h1>
  </div>
